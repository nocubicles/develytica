...
func router() *mux.Router {
	...
	router.HandleFunc("/organizations", middleware.CheckIsUsedLoggedIn(routes.RenderOrganizationPage)).Methods(http.MethodGet, http.MethodPost, http.MethodOptions)
